<div class="container text-light bg-dark rounded mb-4 " style="height: 100vh; width: 900px;">
  <form class="" action="" method="post">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="formGroupExampleInput2" name="first_name" placeholder="Prenom">
    </div>
    <div class="form-group">
      <label for="formGroupExampleInput2">Age</label>
      <input type="number" class="form-control" id="formGroupExampleInput2" name="age" placeholder="Age">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="formGroupExampleInput2" name="street" placeholder="Rue">
    </div>
    <div class="form-group">
